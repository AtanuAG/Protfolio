...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        const mailtoLink = `guchhaitatanu45@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
        ...
        emailElement.addEventListener('click', async () => {
            try {
                if (navigator.clipboard && navigator.clipboard.writeText) {
                    await navigator.clipboard.writeText('guchhaitatanu45@gmail.com');
                    emailElement.style.color = '#4CAF50';
                    emailElement.textContent = 'Email copied!';
                    
                    setTimeout(() => {
                        emailElement.style.color = 'pointer';
                        emailElement.textContent = 'guchhaitatanu45@gmail.com';
                    }, 2000);
                } else {
                    // Fallback for older browsers
                    const textArea = document.createElement('textarea');
                    textArea.value = 'guchhaitatanu45@gmail.com';
                ...
                alert('Email: guchhaitatanu45@gmail.com');
            }
        });
    }
});
